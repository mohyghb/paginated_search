...
class __$$_DataCopyWithImpl<T, $Res>
    extends _$PaginatedStateCopyWithImpl<T, $Res, _$_Data<T>>
...
class _$_Data<T> implements _Data<T> {
  ...
  @override
  String toString() {
    return 'PaginatedState<$T>.data(items: $items)';
  }
...
abstract class _Data<T> implements PaginatedState<T> {
...
class __$$_LoadingCopyWithImpl<T, $Res>
    extends _$PaginatedStateCopyWithImpl<T, $Res, _$_Loading<T>>
...
abstract class _Loading<T> implements PaginatedState<T> {
...
class __$$_ErrorCopyWithImpl<T, $Res>
    extends _$PaginatedStateCopyWithImpl<T, $Res, _$_Error<T>>
...
class _$_Error<T> implements _Error<T> {
  ...
  @override
  String toString() {
    return 'PaginatedState<$T>.error(e: $e, stk: $stk)';
  }
...
abstract class _Error<T> implements PaginatedState<T> {
...
class __$$_OnGoingLoadingCopyWithImpl<T, $Res>
    extends _$PaginatedStateCopyWithImpl<T, $Res, _$_OnGoingLoading<T>>
...
class _$_OnGoingLoading<T> implements _OnGoingLoading<T> {
  ...
  @override
  String toString() {
    return 'PaginatedState<$T>.onGoingLoading(items: $items)';
  }
...
abstract class _OnGoingLoading<T> implements PaginatedState<T> {
...
class __$$_OnGoingErrorCopyWithImpl<T, $Res>
    extends _$PaginatedStateCopyWithImpl<T, $Res, _$_OnGoingError<T>>
...
class _$_OnGoingError<T> implements _OnGoingError<T> {
  ...
  @override
  String toString() {
    return 'PaginatedState<$T>.onGoingError(items: $items, e: $e, stk: $stk)';
  }
...
abstract class _OnGoingError<T> implements PaginatedState<T> {
